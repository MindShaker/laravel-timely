                    ...
                    <div>
                        ...
                        <form action="/admin/logs" method="get">
                            ...
                            <div class="flex justify-between sm:flex flex-wrap">
                                ...
                                <div class="ml-2">
                                    <a href="/admin/logs" class="inline-flex items-center justify-center h-9 px-3 text-content border border-neutral-700 rounded hover:bg-chrome-hover transition duration-150 ease-in-out">
                                        <x-refresh-icon />
                                    </a>
                                </div>
